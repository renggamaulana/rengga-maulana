                        ...
                        return (
                            ...
                            <div className="flex flex-wrap gap-3 mt-4">
                                {project.stacks.map((stack) => {
                                    return(
                                        <span key={stack} className="px-4 py-1 bg-gray-50 border border-orange-600 dark:bg-neutral-900 hover:bg-gray-100 dark:hover:bg-neutral-700 text-orange-500 rounded-full">{stack}</span>
                                    )
                                })}
                            </div>
                        </div>
