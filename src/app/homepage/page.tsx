              ...
              <div className="grid grid-cols-1 gap-3 md:gap-10 md:grid-cols-2">
                ...
                <div className="shadow-lg dark:md:border dark:md:border-gray-700 md:rounded-lg px-3 py-5 md:px-5 md:py-8">
                  <div className="flex flex-wrap md:flex-nowrap items-center gap-5 md:gap-7">
                    ...
                    <a href="https://daphone.my.id" className="hover:text-blue-400 group">
                      <div className="flex gap-5 items-center">
                        <h3 className="text-xl font-semibold group-hover:text-blue-300">Daphone</h3>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 group-hover:-translate-y-1">
              ...
              {/* Atmosight */}
                <div className="shadow-lg dark:md:border dark:md:border-gray-700 md:rounded-lg px-3 py-5 md:px-5 md:py-8">
                  <div className="flex flex-wrap md:flex-nowrap items-center gap-5 md:gap-7">
                    ...
                    <a href="https://atmosight.vercel.app" target="_blank" className="hover:text-blue-400 group">
                      <div className="flex gap-5">
                        <h3 className="text-xl font-semibold group-hover:text-blue-300">Atmosight</h3>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 group-hover:-translate-y-1">
                          <path fill-rule="evenodd" d="M15.75 2.25H21a.75.75 0 0 1 .75.75v5.25a.75.75 0 0 1-1.5 0V4.81L8.03 17.03a.75.75 0 0 1-1.06-1.06L19.19 3.75h-3.44a.75.75 0 0 1 0-1.5Zm-10.5 4.5a1.5 1.5 0 0 0-1.5 1.5v10.5a1.5 1.5 0 0 0 1.5 1.5h10.5a1.5 1.5 0 0 0 1.5-1.5V10.5a.75.75 0 0 1 1.5 0v8.25a3 3 0 0 1-3 3H5.25a3 3 0 0 1-3-3V8.25a3 3 0 0 1 3-3h8.25a.75.75 0 0 1 0 1.5H5.25Z" clip-rule="evenodd" />
                        </svg>
                      </div>
                ...
                <div className="shadow-lg dark:md:border dark:md:border-gray-700 md:rounded-lg px-3 py-5 md:px-5 md:py-8">
                  <div className="flex flex-wrap md:flex-nowrap items-center gap-5 md:gap-7">
                    ...
                    <a href="https://everyday-quotes.vercel.app" target="_blank" className="hover:text-blue-400 group">
                      <div className="flex gap-5">
                        <h3 className="text-xl font-semibold group-hover:text-blue-300">Everyday Quotes</h3>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 group-hover:-translate-y-1">
                          <path fill-rule="evenodd" d="M15.75 2.25H21a.75.75 0 0 1 .75.75v5.25a.75.75 0 0 1-1.5 0V4.81L8.03 17.03a.75.75 0 0 1-1.06-1.06L19.19 3.75h-3.44a.75.75 0 0 1 0-1.5Zm-10.5 4.5a1.5 1.5 0 0 0-1.5 1.5v10.5a1.5 1.5 0 0 0 1.5 1.5h10.5a1.5 1.5 0 0 0 1.5-1.5V10.5a.75.75 0 0 1 1.5 0v8.25a3 3 0 0 1-3 3H5.25a3 3 0 0 1-3-3V8.25a3 3 0 0 1 3-3h8.25a.75.75 0 0 1 0 1.5H5.25Z" clip-rule="evenodd" />
                        </svg>
                      </div>
                ...
                <div className="shadow-lg dark:md:border dark:md:border-gray-700 md:rounded-lg px-3 py-5 md:px-5 md:py-8">
                  <div className="flex flex-wrap md:flex-nowrap items-center gap-5 md:gap-7">
                    ...
                    <a href="https://github.com/renggamaulana/concreteAI-be-assignment" target="_blank" className="hover:text-blue-400 group">
                      <div className="flex gap-5">
                        <h3 className="text-xl font-semibold group-hover:text-blue-300">Transaction Restful API Service</h3>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 group-hover:-translate-y-1">
                          <path fill-rule="evenodd" d="M15.75 2.25H21a.75.75 0 0 1 .75.75v5.25a.75.75 0 0 1-1.5 0V4.81L8.03 17.03a.75.75 0 0 1-1.06-1.06L19.19 3.75h-3.44a.75.75 0 0 1 0-1.5Zm-10.5 4.5a1.5 1.5 0 0 0-1.5 1.5v10.5a1.5 1.5 0 0 0 1.5 1.5h10.5a1.5 1.5 0 0 0 1.5-1.5V10.5a.75.75 0 0 1 1.5 0v8.25a3 3 0 0 1-3 3H5.25a3 3 0 0 1-3-3V8.25a3 3 0 0 1 3-3h8.25a.75.75 0 0 1 0 1.5H5.25Z" clip-rule="evenodd" />
                        </svg>
                      </div>
              ...
              {/* Suzu Nihongo */}
                <div className="shadow-lg dark:md:border dark:md:border-gray-700 md:rounded-lg px-3 py-5 md:px-5 md:py-8">
                  <div className="flex flex-wrap md:flex-nowrap items-center gap-5 md:gap-7">
                    ...
                    <a href="https://suzu-nihongo-idn.vercel.app/" target="_blank" className="hover:text-blue-400 group">
                      <div className="flex gap-5">
                        <h3 className="text-xl font-semibold group-hover:text-blue-300">Suzu Nihongo</h3>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 group-hover:-translate-y-1">
                          <path fill-rule="evenodd" d="M15.75 2.25H21a.75.75 0 0 1 .75.75v5.25a.75.75 0 0 1-1.5 0V4.81L8.03 17.03a.75.75 0 0 1-1.06-1.06L19.19 3.75h-3.44a.75.75 0 0 1 0-1.5Zm-10.5 4.5a1.5 1.5 0 0 0-1.5 1.5v10.5a1.5 1.5 0 0 0 1.5 1.5h10.5a1.5 1.5 0 0 0 1.5-1.5V10.5a.75.75 0 0 1 1.5 0v8.25a3 3 0 0 1-3 3H5.25a3 3 0 0 1-3-3V8.25a3 3 0 0 1 3-3h8.25a.75.75 0 0 1 0 1.5H5.25Z" clip-rule="evenodd" />
                        </svg>
                      </div>
